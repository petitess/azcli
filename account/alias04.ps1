...
$issuer = "https://vstoken.dev.azure.com/xxxx-823d-4a0d-9191-xxxxx"
...
if ($serviceEndpointId) {
    Write-Output "Service endpoint already exists. Update manually."
    # Write-Output "Updating service endpoint"
